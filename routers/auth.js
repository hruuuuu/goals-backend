...
router.post('/signup', async(req, res, next) => {
    ...
    // 加入新用戶資料到資料庫中
    const newAccount = await connection.execute('INSERT INTO goals.member (email, password, verifyString, valid, timeStamp) VALUE (?, ?, ?, ?, ?)', [email, hashPassword, verifyCode, 0, joinTime]);
